...
<div class="container">
    ...
    <table id="cart" class="table table-hover table-condensed">
        ...
        <tr>
            <td>
            <a href="{{ url('/products') }}" class="btn btn-warning"><i class="glyphicon glyphicon-menu-left"></i>Lanjutkan Belanja</a>
            <a href="{{ route('admin.orders.create') }}" class="btn btn-primary">Lanjut ke Pembayaran<i class="glyphicon glyphicon-menu-right"></i></a>
            </td>
