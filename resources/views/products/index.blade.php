        ...
        <div class="col-md-4 offset-md-8">
            <div class="form-group">
                <select id="order_field" class="form-control">
                    ...
                    <option value="dilihat" >Banyak Lihat</option>
                </select>
            </div>
        </div>
    </div>
...
<div id="product-list">
    @foreach($products as $idx => $product)
        ...
        <div class="col-md-3">
            <div class="card"> 
                <img src="{{ asset('image_files/'.$product->image_url) }}" class="thumbail" alt="..." width="200" height="200">
                <div class="card-body">
                    <h5 class="card-title">
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data,function(idx,product){
                    ...
                    '<div class="card">'+'<img src="/image_files/'+ product.image_url+'" class="thumbail" alt="..." width="200" height="200">'+
                    '<div class="card-body">'+
                        '<h5 class="card-title">'+
