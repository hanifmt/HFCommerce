        ...
        @foreach($products as $idx => $product)
            ...
            <div class="row mt-4">
              ...
              <div class="col-md-3">
                <div class="card">
                  @if(!empty($product))
                  <img src="{{ asset('/image_files/'.$product->image_url) }}" class="card-img-top" alt="" width="200" height="200">
                  @endif
                  <div class="card-body">
                    <h5 class="card-title">
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data,function(idx,product){
                    ...
                    '<div class="card">'+'<img src="/image_files/'+ product.image_url+'" class="card-img-top" alt="..." width="200" height="200">'+
                    '<div class="card-body">'+
                        '<h5 class="card-title">'+
